...
- [About the Project](#hll-geofences-for-advanced-seeding)
- [Features](#features)
- [Prerequisites](#prerequisites)
- [Express Installation](#express-installation)
- [Manual Installation](#manual-installation)
- [Optional: Discord Bot Setup](#optional-discord-bot-setup)
- [Restart Script](#restart-script)
- [Operational Notes](#operational-notes)
- [Managing Docker Instances](#managing-docker-instances)
